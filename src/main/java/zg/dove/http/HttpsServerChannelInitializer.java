 ...
 * @create 2018-11-28
 */
public class HttpsServerChannelInitializer extends HttpServerChannelInitializer {

    private final SslContext sslContext;

    public HttpsServerChannelInitializer(File cert, File key, String password, IFilter filter, IRoute route) throws Exception {
        super(filter, route);
